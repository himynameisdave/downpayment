...
<Layout includeBackLink>
  ...
  <ul>
    ...
    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Downpayment Calculator Canada.</li>
    ...
    <li><strong>Website</strong> refers to Downpayment Calculator Canada, accessible from downpaymentcalculator.ca</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
  </ul>
  ...
  <ul>
  <li>By email: hello@downpaymentcalculator.ca</li>
  </ul>
</Layout>
